  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3 text-2xl text-islamic-green-800 dark:text-islamic-green-200">
          ...
          <DialogDescription className="text-base text-islamic-green-600 dark:text-islamic-green-400 mt-4">
        ...
        <div className="space-y-6 mt-6">
          ...
          <div className="grid gap-4">
            <div className="flex items-start gap-4 p-4 rounded-lg bg-islamic-green-50 dark:bg-islamic-green-900/20 border border-islamic-green-200 dark:border-islamic-green-700">
              <div className="w-10 h-10 bg-islamic-green-500 rounded-lg flex items-center justify-center flex-shrink-0">
                <BookOpen className="w-5 h-5 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-islamic-green-800 dark:text-islamic-green-200 mb-2">
                  Comprehensive Knowledge Base
                </h3>
                <p className="text-sm text-islamic-green-600 dark:text-islamic-green-400">
            ...
            <div className="flex items-start gap-4 p-4 rounded-lg bg-islamic-teal-50 dark:bg-islamic-teal-900/20 border border-islamic-teal-200 dark:border-islamic-teal-700">
              <div className="w-10 h-10 bg-islamic-teal-500 rounded-lg flex items-center justify-center flex-shrink-0">
                <Shield className="w-5 h-5 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-islamic-teal-800 dark:text-islamic-teal-200 mb-2">
                  Sharia-Compliant Guidance
                </h3>
                <p className="text-sm text-islamic-teal-600 dark:text-islamic-teal-400">
            ...
            <div className="flex items-start gap-4 p-4 rounded-lg bg-islamic-gold-50 dark:bg-islamic-gold-900/20 border border-islamic-gold-200 dark:border-islamic-gold-700">
              <div className="w-10 h-10 bg-islamic-gold-500 rounded-lg flex items-center justify-center flex-shrink-0">
                <Zap className="w-5 h-5 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-islamic-gold-800 dark:text-islamic-gold-200 mb-2">
                  AI-Powered Insights
                </h3>
                <p className="text-sm text-islamic-gold-600 dark:text-islamic-gold-400">
