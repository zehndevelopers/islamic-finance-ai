...
const sendChatMessage = async (content: string, sessionId: string): Promise<ChatResponse> => {
...
export function useChat(): UseChatReturn {
  ...
  const sendMessage = useCallback(async ({ content, sessionId }: SendMessageParams) => {
    if (!user) {
